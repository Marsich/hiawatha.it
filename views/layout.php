...
clearstatcache();
$last_modified = date('d-m-Y H:i', filemtime(urldecode($_SERVER['DOCUMENT_ROOT'] . '/library' . $_SERVER['REQUEST_URI'])));
?>
<!DOCTYPE html>
<html>
    <head>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-9">
                        <div id="content">
                            <div class="inner">
                                <?php echo $content; ?>
                                <br /><span class="pull-left"><a href="mailto:paolo@hiawatha.it">&nbsp;[Segnala un errore o un'imprecisione]&nbsp;</a></span><span class="pull-right btn-black">Ultimo aggiornamento: <?=$last_modified?></span><br />
                            </div>
                        </div>
                    </div>
                </div>
